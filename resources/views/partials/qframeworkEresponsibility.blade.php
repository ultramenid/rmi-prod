{{-- qframework6 --}}
<div class="w-full border border-gray-200 dark:border-opacity-20 rounded min-h-screen bg-gray-300 px-4 py-4" x-show="tema === 'erdescription'" x-transition x-cloak style="display: none !important"
x-data="qframework6">
